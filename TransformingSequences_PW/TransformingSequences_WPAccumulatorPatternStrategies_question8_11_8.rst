...
.. mchoice:: TransformingSequences_WPAccumulatorPatternStrategies_question8_11_8
    :prim_comp: ITER05
    :supp_comp: DT01, SEQ01
    :answer_a: wrds
    :answer_b: past_wrds
    ...
    What sequence will you iterate through as you accumulate a result in the following prompt? 
